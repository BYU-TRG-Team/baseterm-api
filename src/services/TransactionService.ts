...
class TransactionService {
  ...
  public async constructTransaction(
    ...
    // Next we just have to plug this into Post Term (origination), Post Language (origination for term and language). and post concept entry (origination for all)
    // Patch Term (modification) (automate change into an array and then make that the note), same with concept entry and language section
    // we should be able to expand tests to check the existence of these transaction groups
