...
HTTP REST API and PostgreSQL schemas built for [TermBase eXchange](https://www.tbxinfo.net) (TBX) v3. The API currently supports the [TBX-Basic](https://www.tbxinfo.net/tbx-dialects/?id=2) dialect and [Data Category as Attribute](https://www.tbxinfo.net/dca-v-dct) (DCA) style. The API and PostgreSQL schemas are part of the [BaseTerm](https://github.com/BYU-TRG-Team/baseterm) web application.
