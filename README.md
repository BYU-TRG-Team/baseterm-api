...
<details>
  ...
  Body: {
    message: "Invalid query params supplied."
  }
  ```
...
<details>
  ...
  Body: {
    message: "A base already exists with the same name."
  }
  ```
...
<details>
  ...
  Body: {
    message: "Language Sections must have at least one term."
  }
  ```
...
<details>
  ...
  Body: {
    message: "Target does not reference a known ID"
  }
  ```
  ...
  Body: {
    message: "ID is invalid. ID must follow convention for XML."
  }
  ```
  ...
  Body: {
    message: "A TBX element already exists with the same ID."
  }
  ```
...
<details>
  ...
  Body: {
    message: "The supplied user id does not match the requester's user id."
  }
  ```
  ...
  Body: {
    message: "Person ID must be a UUID."
  }
  ```
...
<details>
  ...
  Body: {
    message: "Concept entries must have at least one language section."
  }
  ```
